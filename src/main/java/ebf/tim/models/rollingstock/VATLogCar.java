...
public class VATLogCar extends ModelBase
{
	...
	public VATLogCar()
	{
		...
		vatlogcarModel[0].addBox(0F, 0F, 0F, 18, 2, 44, 0F); // Box 0
		vatlogcarModel[0].setRotationPoint(-9F, -2F, -22F);

		vatlogcarModel[1].addBox(0F, 0F, 0F, 16, 5, 44, 0F); // Box 1
		vatlogcarModel[1].setRotationPoint(-8F, 0F, -22F);

		vatlogcarModel[2].addBox(0F, 0F, 0F, 1, 15, 1, 0F); // Box 5
		vatlogcarModel[2].setRotationPoint(-10F, -15F, -16F);

		vatlogcarModel[3].addBox(0F, 0F, 0F, 1, 15, 1, 0F); // Box 6
		vatlogcarModel[3].setRotationPoint(-10F, -15F, 16F);

		vatlogcarModel[4].addBox(0F, 0F, 0F, 1, 15, 1, 0F); // Box 7
		vatlogcarModel[4].setRotationPoint(-10F, -15F, 6F);

		vatlogcarModel[5].addBox(0F, 0F, 0F, 1, 15, 1, 0F); // Box 8
		vatlogcarModel[5].setRotationPoint(-10F, -15F, -6F);

		vatlogcarModel[6].addBox(0F, 0F, 0F, 1, 15, 1, 0F); // Box 9
		vatlogcarModel[6].setRotationPoint(9F, -15F, 16F);

		vatlogcarModel[7].addBox(0F, 0F, 0F, 1, 15, 1, 0F); // Box 10
		vatlogcarModel[7].setRotationPoint(9F, -15F, 6F);

		vatlogcarModel[8].addBox(0F, 0F, 0F, 1, 15, 1, 0F); // Box 11
		vatlogcarModel[8].setRotationPoint(9F, -15F, -6F);

		vatlogcarModel[9].addBox(0F, 0F, 0F, 1, 15, 1, 0F); // Box 12
		vatlogcarModel[9].setRotationPoint(9F, -15F, -16F);

		vatlogcarModel[10].addBox(0F, 0F, 0F, 20, 4, 1, 0F); // Box 13
		vatlogcarModel[10].setRotationPoint(-10F, 0F, 22F);

		vatlogcarModel[11].addBox(0F, 0F, 0F, 20, 4, 1, 0F); // Box 14
		vatlogcarModel[11].setRotationPoint(-10F, 0F, -23F);

		vatlogcarModel[12].addBox(0F, 0F, 0F, 1, 1, 4, 0F); // Box 15
		vatlogcarModel[12].setRotationPoint(0F, 4F, 22F);

		vatlogcarModel[13].addBox(0F, 0F, 0F, 2, 2, 1, 0F); // Box 16
		vatlogcarModel[13].setRotationPoint(-0.5F, 3.5F, 26F);

		vatlogcarModel[14].addBox(0F, 0F, 0F, 2, 2, 1, 0F); // Box 17
		vatlogcarModel[14].setRotationPoint(-0.5F, 3.5F, -27F);

		vatlogcarModel[15].addBox(0F, 0F, 0F, 1, 1, 4, 0F); // Box 18
		vatlogcarModel[15].setRotationPoint(0F, 4F, -26F);

		vatlogcarModel[16].addBox(-4F, -4F, -4F, 8, 8, 8, 0F); // logblock 1
		vatlogcarModel[16].setRotationPoint(4F, -6F, -20F);
		vatlogcarModel[16].rotateAngleX = 1.57079633F;

		vatlogcarModel[17].addBox(-4F, -4F, -4F, 8, 8, 8, 0F); // logblock 2
		vatlogcarModel[17].setRotationPoint(-4F, -6F, -20F);
		vatlogcarModel[17].rotateAngleX = 1.57079633F;

		vatlogcarModel[18].addBox(-4F, -4F, -4F, 8, 8, 8, 0F); // logblock 2
		vatlogcarModel[18].setRotationPoint(-4F, -6F, -12F);
		vatlogcarModel[18].rotateAngleX = 1.57079633F;

		vatlogcarModel[19].addBox(-4F, -4F, -4F, 8, 8, 8, 0F); // logblock 1
		vatlogcarModel[19].setRotationPoint(4F, -6F, -12F);
	...
	public ModelRendererTurbo vatlogcarModel[];
}