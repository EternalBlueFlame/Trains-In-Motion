...
public class ModelRailCurveVerySmall extends ModelBase
{
	...
	public ModelRailCurveVerySmall()
	{
		...
		baseModel[0].addBox(-2F, 0F, 0F, 5, 1, 2, 0F); // Box 17
		baseModel[0].setRotationPoint(-7F, 5F, 4F);

		baseModel[1].addBox(-1F, 0F, 0F, 2, 1, 2, 0F); // Box 19
		baseModel[1].setRotationPoint(-8F, 5F, -6F);

		baseModel[2].addBox(-1F, 0F, 0F, 2, 1, 2, 0F); // Box 26
		baseModel[2].setRotationPoint(-6F, 5F, -8F);
		baseModel[2].rotateAngleY = -1.57079633F;

		baseModel[3].addBox(-2F, 0F, 0F, 5, 1, 2, 0F); // Box 68
		...
		baseModel[9].addBox(-2F, 0F, 0F, 5, 1, 2, 0F); // Box 36
		baseModel[9].setRotationPoint(4F, 7F, -6F);
		baseModel[9].rotateAngleY = -1.57079633F;

		baseModel[10].addBox(-2F, 0F, 0F, 5, 1, 2, 0F); // Box 40
		baseModel[10].setRotationPoint(-7F, 7F, 4F);

		baseModel[11].addBox(-1F, 0F, 0F, 2, 1, 2, 0F); // Box 41
		baseModel[11].setRotationPoint(-8F, 7F, -6F);

		baseModel[12].addBox(-1F, 0F, 0F, 2, 1, 2, 0F); // Box 43
		baseModel[12].setRotationPoint(-6F, 7F, -8F);
		baseModel[12].rotateAngleY = -1.57079633F;

		baseModel[13].addBox(-2F, 0F, 0F, 5, 1, 1, 0F); // Box 44
		...
		baseModel[17].addBox(-2F, 0F, 0F, 5, 1, 1, 0F); // Box 48
		baseModel[17].setRotationPoint(-7F, 6F, 4.5F);
		...
		baseModel[20].addBox(-1F, 0F, 0F, 2, 1, 1, 0F); // Box 52
		baseModel[20].setRotationPoint(-8F, 6F, -5.5F);

		baseModel[21].addBox(-1F, 0F, 0F, 2, 1, 1, 0F); // Box 54
