...
public class Brigadelok_080 extends ModelBase //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[78] = new ModelRendererTurbo(this, 121, 65, textureX, textureY, StaticModelAnimator.tagSimpleRotate); // wheel
		bodyModel[79] = new ModelRendererTurbo(this, 153, 65, textureX, textureY, StaticModelAnimator.tagSimpleRotate); // wheel
		bodyModel[80] = new ModelRendererTurbo(this, 33, 73, textureX, textureY, StaticModelAnimator.tagSimpleRotate); // wheel
		bodyModel[81] = new ModelRendererTurbo(this, 49, 73, textureX, textureY, StaticModelAnimator.tagSimpleRotate); // wheel
		bodyModel[82] = new ModelRendererTurbo(this, 121, 73, textureX, textureY, StaticModelAnimator.tagSimpleRotate); // wheel
		bodyModel[83] = new ModelRendererTurbo(this, 153, 73, textureX, textureY, StaticModelAnimator.tagSimpleRotate); // wheel
		bodyModel[84] = new ModelRendererTurbo(this, 1, 81, textureX, textureY, StaticModelAnimator.tagSimpleRotate); // wheel
		bodyModel[85] = new ModelRendererTurbo(this, 1, 89, textureX, textureY, StaticModelAnimator.tagSimpleRotate); // wheel
		...
		bodyModel[111] = new ModelRendererTurbo(this, 0, 0, textureX, textureY, "lamp"); // lamp
		bodyModel[112] = new ModelRendererTurbo(this, 0, 0, textureX, textureY, "smoke 3 232323"); // smoke
		bodyModel[113] = new ModelRendererTurbo(this, 0, 0, textureX, textureY, "steam 3 CCCCCC"); // steam
		bodyModel[114] = new ModelRendererTurbo(this, 0, 0, textureX, textureY, "steam 3 CCCCCC"); // steam
