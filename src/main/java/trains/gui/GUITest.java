...
public class GUITest extends GuiContainer {
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ...
        this.mc.renderEngine.bindTexture(new ResourceLocation(TrainsInMotion.enumResources.RESOURCES.getValue(), TrainsInMotion.enumResources.GUI_PREFIX.getValue() + "gui_example.png"));
        int x = (width - xSize) / 2;
