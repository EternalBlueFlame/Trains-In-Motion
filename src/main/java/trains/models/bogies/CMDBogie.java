...
public class CMDBogie extends ModelBase
{
	...
	public CMDBogie()
	{
		...
		cmdbogieModel[0].addBox(0F, 0F, 0F, 0, 4, 4, 0F); // Wheel 5
		cmdbogieModel[0].setRotationPoint(5F, 6F, -4F);

		cmdbogieModel[1].addBox(0F, 0F, 0F, 0, 4, 4, 0F); // Wheel 8
		cmdbogieModel[1].setRotationPoint(-5F, 6F, -4F);

		cmdbogieModel[2].addBox(0F, 0F, 0F, 0, 4, 4, 0F); // Wheel 7
		cmdbogieModel[2].setRotationPoint(-4.5F, 6F, -4F);

		cmdbogieModel[3].addBox(0F, 0F, 0F, 0, 4, 4, 0F); // Wheel 6
		cmdbogieModel[3].setRotationPoint(4.5F, 6F, -4F);

		cmdbogieModel[4].addBox(0F, 0F, 0F, 12, 1, 1, 0F); // Axel 1
		cmdbogieModel[4].setRotationPoint(-6F, 7.5F, -2.5F);

		cmdbogieModel[5].addBox(0F, 0F, 0F, 0, 4, 4, 0F); // Wheel 4
		cmdbogieModel[5].setRotationPoint(5F, 6F, 4F);

		cmdbogieModel[6].addBox(0F, 0F, 0F, 0, 4, 4, 0F); // Wheel 3
		cmdbogieModel[6].setRotationPoint(4.5F, 6F, 4F);

		cmdbogieModel[7].addBox(0F, 0F, 0F, 12, 1, 1, 0F); // Axel 2
		cmdbogieModel[7].setRotationPoint(-6F, 7.5F, 5.5F);

		cmdbogieModel[8].addBox(0F, 0F, 0F, 0, 4, 4, 0F); // Wheel 2
		cmdbogieModel[8].setRotationPoint(-4.5F, 6F, 4F);

		cmdbogieModel[9].addBox(0F, 0F, 0F, 0, 4, 4, 0F); // Wheel 1
		cmdbogieModel[9].setRotationPoint(-5F, 6F, 4F);
